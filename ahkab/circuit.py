...
class Circuit(list):
    ...
    **Parameters:**
    ...
    def add_mysistor(self, part_id, n1, n2, value, rho_b, length_channel, rbrt, pressure):
        ...
        **Parameters:**
        ...
        elem = components.Mysistor(part_id=part_id, n1=n1, n2=n2, value=value, rho_b=rho_b, length_channel=length_channel, rbrt=rbrt, pressure=pressure)
        self.append(elem)
